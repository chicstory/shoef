...
SHOES = [
    ...
    },
    {
        ...
        "runrepeat": {
            ...
            "pros": ["균형 잡힌 충격 완화력", "우수한 지면 접지력과 내마모성", "발볼이 편안한 엔지니어드 메쉬"],
            "cons": ["10km 이상 장거리 러닝 시 쿠션 가라앉음 체감"],
    ...
    },
    {
        ...
        "runrepeat": {
            ...
            "pros": ["100달러 미만에서 아디제로급 Lightstrike 폼 탑재", "264g의 경쾌한 무게로 템포런 가능", "아디웨어 아웃솔의 끈질긴 수명"],
            "cons": ["미드솔 초반 착화감이 다소 단단함(Firm)"],
    ...
    },
    {
        ...
        "runrepeat": {
            "score": 91,
            "midsole_foam": "Dreamstrike+",
            "pros": ["압도적으로 두터운 맥스 쿠셔닝", "장거리 LSD에서도 죽지 않는 서포트력", "부드러운 프리미엄 어퍼 마감"],
            "cons": ["스피드 러닝에는 다소 묵직함"],
    ...
    # ------------------ ASICS ------------------
    {
        ...
        "runrepeat": {
            ...
            "pros": ["압도적인 가성비와 4E 슈퍼와이드 발볼 지원", "동양인 족형에 가장 잘 맞는 편안한 피팅", "질긴 내구성"],
            "cons": ["고속 반발력 부족"],
    ...
    },
    {
        ...
        "runrepeat": {
            ...
            "pros": ["메타스피드 레이서용 슈퍼폼(FF TURBO+) 전격 탑재", "45mm 합법적 규정 초과 쿠션인데 249g이라는 비현실적 무게", "카본 없이도 대회 풀코스를 뛸 수 있는 최고의 편안함"],
            "cons": ["전세계 품절 대란으로 구매하기 어려움"],
    ...
    },
    {
        ...
        "runrepeat": {
            "score": 95,
            "midsole_foam": "FF TURBO+",
            "pros": ["183g 깃털 같은 무게와 넓은 밑창 안정감", "보폭(스트라이드)을 늘려주는 환상적인 위로 솟구치는 탄성", "ASICSGRIP 아웃솔의 빗길 최강 접지"],
            "cons": ["강한 종아리 근력을 요구함"],
    ...
    # ------------------ NEW BALANCE ------------------
    {
        ...
        "runrepeat": {
            ...
            "pros": ["뉴발란스 고유의 프레쉬폼 쿠션을 8만원대에 경험", "가볍고 통기성 뛰어난 니트 어퍼", "4E 와이드 지원"],
            "cons": ["장거리 마일리지용으로는 얇은 스택"],
    ...
    },
    {
        ...
        "runrepeat": {
            ...
            "pros": ["208g이라는 깃털 같은 무게", "PEBA 폼 블렌드로 미친 반응성과 쫀득함", "넓어진 밑창으로 전작의 좌우 흔들림 완벽 개선"],
            "cons": ["어퍼가 얇아 겨울철 발 시려움"],
    ...
    },
    {
        ...
        "runrepeat": {
            ...
            "pros": ["드디어 100% 순수 PEBA 폼 탑재로 폭발적인 에너지 리턴", "카본 레이싱화 중 유일하게 2E 와이드 발볼 정식 지원", "아치 통증 없는 최고의 편안함"],
            "cons": ["180g대 초경량 레이서 대비 무게가 살짝 있음"],
    ...
    # ------------------ PUMA ------------------
    {
        ...
        "runrepeat": {
            ...
            "pros": ["PROTREAD 고무 아웃솔의 우수한 접지력", "깔끔한 스트리트 러닝 룩", "가성비 뛰어난 내구성"],
            "cons": ["고급 니트로 폼 대비 반발력 한계"],
    ...
    },
    {
        ...
        "runrepeat": {
            ...
            "pros": ["PUMAGRIP 아웃솔의 전 세계 1위 젖은 노면 접지력", "질소 주입 니트로 폼의 통통 튀는 경쾌한 탄성", "14만원대 믿기 힘든 퀄리티"],
            "cons": ["발볼이 다소 타이트한 편 (반업 추천)"],
    ...
    },
    {
        ...
        "runrepeat": {
            ...
            "pros": ["엘리트 니트로 폼과 카본 플레이트의 공격적인 추진력", "미끄러짐 없는 절대 접지력 PUMAGRIP", "조깅부터 마라톤 대회까지 모두 소화"],
            "cons": ["뒤꿈치 힐 패딩이 얇아 힐슬립 체크 필요"],
    ...
    # ------------------ MIZUNO ------------------
    {
        ...
        "runrepeat": {
            ...
            "pros": ["힐에 ENERZY NXT 슈퍼폼 탑재로 착지 충격 완벽 분산", "웨이브 플레이트 고유의 탄탄하고 흔들림 없는 안정감", "X10 카본 러버의 1,000km 내구성"],
            "cons": ["소프트한 구름 쿠션을 선호하는 러너에게는 탄탄함"],
    ...
    },
    {
        ...
        "runrepeat": {
            ...
            "pros": ["뒤꿈치가 잘려나간 혁신적인 힐리스 지오메트리", "강제적인 완벽한 미드풋/포어풋 착지 유도", "G3 아웃솔의 지면을 파고드는 접지력"],
            "cons": ["힐 스트라이커 러너는 착용 불가능"],
    ...
    # ------------------ ON RUNNING ------------------
    {
        ...
        "runrepeat": {
            ...
            "pros": ["헬리온 슈퍼폼 도입으로 전작 대비 훨씬 부드러워진 착지감", "돌 끼임 현상 완벽 개선", "온 러닝 특유의 세련된 프리미엄 디자인"],
            "cons": ["온 브랜드 특성상 100달러 미만 엔트리가 없음"],
    ...
    },
    {
        ...
        "runrepeat": {
            ...
            "pros": ["온 최초의 100% Pebax(Helion HF) 슈퍼폼 탑재", "카본 스피드보드의 날카로운 가속과 킥", "초미세 마이크로파이버 깃털 어퍼"],
            "cons": ["매우 높은 34만원대 정가"],
...
def main():
    ...
    # Save to data/shoes_master.json
