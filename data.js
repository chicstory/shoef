/** ShoeF Master Database (2023-2026 Master Dataset) **/
window.SHOEF_CONFIG = {
  "brands": [
    {
      "id": "adidas",
...
window.SHOEF_MASTER = [
  {
    ...
    "runrepeat": {
      ...
      "pros": [
        ...
        "전작 대비 통기성이 대폭 강화된 신형 어퍼",
        "워킹부터 헬스장 트레드밀까지 든든한 내구성"
      ],
      "cons": [
        "290g대 무게감",
        "스피드 러닝에는 탄성 부족"
  ...
  },
  {
    ...
    "specs": {
      "weight_g": 272,
      "heel_drop_mm": 9.5,
      "midsole": "Lightmotion 쿠셔닝",
      "plate": "없음",
      "stack_height": "33mm / 23.5mm",
    ...
    "runrepeat": {
      ...
      "verdict": "가벼운 운동과 헬스장을 시작하는 입문자를 위한 가성비 모델.",
      "url": "https://runrepeat.com/adidas-duramo-sl"
    },
    "gen_type": "current",
    "release_year": 2025
  },
  ...
  },
  {
    ...
    "specs": {
      "weight_g": 268,
      "heel_drop_mm": 10,
      "midsole": "Dreamstrike+ (앞발) + Carrier EVA (뒤)",
      "plate": "없음",
    ...
    "runrepeat": {
      ...
      "verdict": "슈퍼노바 시리즈 중 가장 접근하기 쉬운 실속형 데일리 쿠션화.",
      "url": "https://runrepeat.com/adidas-supernova-stride"
    },
    "gen_type": "current",
    "release_year": 2025
  },
  {
    ...
    "specs": {
      "weight_g": 272,
      "heel_drop_mm": 10,
      "midsole": "Dreamstrike+ 2.0 + 서포트 로드",
      "plate": "바텀 서포트 로드 (EVA)",
    ...
    "runrepeat": {
      ...
      "pros": [
        ...
        "Dreamstrike+ 폼의 쫄깃하고 통통 튀는 발구름",
        "초보부터 상급자 조깅까지 호불호 없는 완성도"
      ],
      "cons": [
        "스피드 레이싱용보다는 지속주 및 조깅 특화"
      ],
  ...
  },
  {
    ...
    "runrepeat": {
      ...
      "verdict": "평발이나 발목 무너짐이 있는 러너에게 쿠션과 안정을 선물하는 신개념 안정화.",
  ...
  },
  {
    ...
    "runrepeat": {
      ...
      "pros": [
        ...
        "40mm 초대형 맥스 쿠션으로 무릎 충격 차단",
        "체중 있는 러너도 무너지지 않는 안정적인 플랫폼"
      ],
      "cons": [
        "300g대의 무게감"
      ],
  ...
  },
  {
    ...
    "specs": {
      "weight_g": 224,
      "heel_drop_mm": 8.5,
      "midsole": "Full 100% Lightstrike Pro",
      "plate": "없음",
  ...
  },
  {
    ...
    "runrepeat": {
      ...
      "pros": [
        ...
        "트랙 인터벌과 5k/10k를 찢어발기는 날카로운 지면 피드백",
        "유연하고 경쾌한 발구름"
      ],
      "cons": [
        "낮은 스택으로 풀마라톤에서는 종아리 피로 누적"
      ],
  ...
  },
  {
    ...
    "runrepeat": {
      ...
      "pros": [
        ...
        "더욱 부드럽고 튀어오르는 신형 라이트스트라이크 프로",
        "새로운 로커 포인트로 전진 가속력 강화"
      ],
      "cons": [
        "힐 착지 러너에게는 여전히 타이트한 안정성"
      ],
  ...
  },
  {
    ...
    "runrepeat": {
      ...
      "pros": [
        ...
        "풍성한 풀 ZoomX의 쫄깃하고 부드러운 반발력",
        "장거리 LSD와 회복 러닝에 완벽한 무릎 보호"
      ],
      "cons": [
        "높은 스택으로 급격한 코너링 시 주의"
      ],
  ...
  },
  {
    ...
    "specs": {
      "weight_g": 245,
      "heel_drop_mm": 10,
      "midsole": "Full ZoomX (페가수스 터보 후속)",
      "plate": "없음",
      "stack_height": "35mm / 25mm",
    ...
    "runrepeat": {
      ...
      "pros": [
        "전설의 페가수스 터보의 완벽한 귀환",
        "풀 ZoomX 폼의 경쾌한 탄성",
        "플레이트 없이 매일 신을 수 있는 스피드 트레이너"
      ],
      "cons": [
        "보메로 18 대비 얇은 쿠션감"
      ],
      "verdict": "가볍고 경쾌한 템포런을 원하는 러너들의 향수를 자극하는 슈퍼 데일리.",
  ...
  },
  {
    ...
    "runrepeat": {
      ...
      "pros": [
        ...
        "통통 튀는 트램펄린 반발력이 역대급으로 개선",
        "조깅부터 템포런까지 완벽한 재미를 선사"
      ],
      "cons": [
        "심한 평발/과회내 러너는 카야노 추천"
      ],
  ...
  },
  {
    ...
    "runrepeat": {
      ...
      "pros": [
        ...
        "더 쾌적해진 신형 엔지니어드 니트 어퍼",
        "무릎과 관절을 완벽하게 보호하는 마법의 쿠션"
      ],
      "cons": [
        "레이싱용으로는 다소 묵직함"
      ],
  ...
  },
  {
    ...
    "specs": {
      "weight_g": 275,
      "heel_drop_mm": 8,
      "midsole": "FF BLAST+ & 3D 가이던스 시스템 + PureGEL",
      "plate": "없음",
      "stack_height": "36.5mm / 28.5mm",
    ...
    "runrepeat": {
      ...
      "cons": [
        "초고탄성 슈퍼폼을 선호하면 다소 정직함"
      ],
      "verdict": "가볍고 안정적인 발걸음을 원하는 중립/과회내 러너의 올라운더.",
  ...
  },
  {
    ...
    "runrepeat": {
      ...
      "pros": [
        ...
        "겨울철 영하 날씨에도 얼지 않고 쫄깃한 쿠션",
        "조깅부터 템포런까지 완벽한 밸런스"
      ],
      "cons": [
        "극단적 맥스쿠션을 원하는 러너에게는 탄탄함"
      ],
  ...
  },
  {
    ...
    "specs": {
      "weight_g": 286,
      "heel_drop_mm": 10,
      "midsole": "Full PWRRUN PB (슈퍼폼 100% 전면 배치)",
      "plate": "없음",
      "stack_height": "37mm / 27mm",
    ...
    "runrepeat": {
      ...
      "verdict": "써코니가 선사하는 가장 럭셔리하고 쫄깃한 프리미엄 맥스 쿠션 트레이너.",
  ...
  },
  {
    ...
    "specs": {
      "weight_g": 265,
      "heel_drop_mm": 6,
      "midsole": "PWRRUN + 진화된 Center Path 테크놀로지",
      "plate": "없음",
    ...
    "runrepeat": {
      ...
      "pros": [
        ...
        "265g 가벼운 무게",
        "낮은 6mm 드롭으로 부드러운 발구름"
      ],
      "cons": [
        "푹신한 물쿠션을 기대하면 다소 지지력 중심"
      ],
      "verdict": "인위적이지 않고 자연스럽게 발목을 잡아주는 2025 최신 경량 안정화.",
  ...
  },
  {
    ...
    "specs": {
      "weight_g": 307,
      "heel_drop_mm": 4,
      "midsole": "울트라 라이트 EVA 맥스 쿠션",
      "plate": "없음",
      "stack_height": "39mm / 35mm",
    ...
    "runrepeat": {
      ...
      "verdict": "발목과 무릎을 가장 완벽하게 보호해주는 지상 최강의 맥스 쿠션화.",
  ...
  },
  {
    ...
    "specs": {
      "weight_g": 275,
      "heel_drop_mm": 5,
      "midsole": "J-Frame 다이나믹 서포트 EVA",
      "plate": "없음",
      "stack_height": "34mm / 29mm",
    ...
    "runrepeat": {
      ...
      "verdict": "안정화는 무겁고 투박하다는 편견을 깨주는 호카의 대표 안정화.",
  ...
  },
  {
    ...
    "specs": {
      "weight_g": 260,
      "heel_drop_mm": 5,
      "midsole": "PEBA 슈퍼폼 + Pebax 윙 플레이트 + 메타 로커",
      "plate": "Pebax Winged Plate",
      "stack_height": "44mm / 39mm",
    ...
    "runrepeat": {
      ...
      "pros": [
        ...
        "대회와 장거리 훈련을 넘나드는 탄성",
        "시엘로 X1의 감성을 트레이너에 담음"
      ],
      "cons": [
        "힐 칼라 피팅 호불호"
      ],
      "verdict": "호카 특유의 락커와 페박스 플레이트가 결합된 최고의 훈련 파트너.",
  ...
  },
  {
    ...
    "runrepeat": {
      ...
      "verdict": "매일 묵묵히 마일리지를 채워주는 뉴발란스의 대표 데일리 러닝화.",
      "url": "https://runrepeat.com/new-balance-fresh-foam-x-880-v14"
    },
    "gen_type": "current",
    "release_year": 2025
  },
  {
    ...
    "runrepeat": {
      ...
      "pros": [
        ...
        "발등과 뒤꿈치를 단단하게 잡아주는 신형 어퍼",
        "발볼 넓은 한국인 러너를 위한 완벽한 2E/4E 옵션"
      ],
      "cons": [
        "전작 대비 약간 무거워진 무게"
      ],
  ...
  },
  {
    ...
    "specs": {
      "weight_g": 298,
      "heel_drop_mm": 8,
      "midsole": "Fresh Foam X + 신형 EVA Stability Plane 플레이트",
      "plate": "EVA Stability Plane",
      "stack_height": "36mm / 28mm",
    ...
    "runrepeat": {
      ...
      "cons": [
        "빠른 템포런보다는 안정 조깅에 최적화"
      ],
      "verdict": "평발 러너들의 영원한 동반자 860의 가장 세련된 최신 진화형.",
  ...
  },
  {
    ...
    "specs": {
      "weight_g": 274,
      "heel_drop_mm": 10,
      "midsole": "듀얼 덴시티 NITROFOAM + RUNGUIDE 림",
      "plate": "없음",
      "stack_height": "36mm / 26mm",
    ...
    "runrepeat": {
      ...
      "verdict": "과회내 러너를 위한 가장 혁신적이고 푹신한 최신 테크 안정화.",
      "url": "https://runrepeat.com/puma-foreverrun-nitro"
    },
    "gen_type": "current",
    "release_year": 2025
  },
  ...
  },
  {
    ...
    "specs": {
      "weight_g": 194,
      "heel_drop_mm": 8,
      "midsole": "100% NITROFOAM ELITE (지방족 TPU/PEBA) + 풀 카본 플레이트",
      "plate": "Full Carbon INNOPLATE",
      "stack_height": "40mm / 32mm",
    ...
    "runrepeat": {
      ...
      "pros": [
        ...
        "PUMAGRIP-LT의 빗길 절대 접지",
        "가성비 뛰어난 20만원대 카본 레이싱화"
      ],
      "cons": [
        "발볼이 좁아 칼발 러너에게 최적"
      ],
      "verdict": "비 오는 날 마라톤 대회에서 타 브랜드를 압도하는 접지력 끝판왕 카본화.",
  ...
  },
  {
    ...
    "runrepeat": {
      ...
      "pros": [
        ...
        "질소 폼의 탄력적인 충격 흡수",
        "1,000km 뛰어도 멀쩡한 내구성 종결자"
      ],
      "cons": [
        "빠른 레이스보다는 조깅과 장거리 훈련에 최적화"
      ],
  ...
  },
  {
    ...
    "specs": {
      "weight_g": 278,
      "heel_drop_mm": 10,
      "midsole": "DNA LOFT v3 질소 주입 맥스 스택",
      "plate": "없음",
    ...
    "runrepeat": {
      ...
      "verdict": "구름 위를 달리는 듯한 안락함을 선사하는 브룩스의 플래그십 쿠션화.",
  ...
  },
  {
    ...
    "specs": {
      "weight_g": 295,
      "heel_drop_mm": 12,
      "midsole": "MIZUNO ENERZY + 아나토미컬 웨이브 서포트 플레이트",
      "plate": "Double Fan-shaped Wave Plate",
      "stack_height": "37.5mm / 25.5mm",
    ...
    "runrepeat": {
      ...
      "verdict": "발목 힘이 약하고 평발인 러너에게 가장 견고한 방패가 되어주는 안정화.",
